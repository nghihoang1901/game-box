      ...
      <div className="poster">
        <div className="container">
          <div className="poster-info">
            <h3>
              Nunc cursus dui in metus efficitur, sit amet ullamcorper dolor
              viverra.
            </h3>
            <p>
              ...
              dignissim. Morbi magna quam, molestie sed fermentum et, elementum
              at dolor
            </p>
            <a className="hvr-bounce-to-bottom" href="reviews.html">
              Read More
            </a>
          </div>
        </div>
